...
export const zhCN: MessageTree = {
	...
	explore: {
		...
		subtitleAnimated: '静态图片也能呈现内置动态的效果。点击即可在编辑器中预览。',
		tabs: { effects: '特效', animated: '动态' },
		search: '搜索特效…',
		searchAnimated: '搜索动态特效…',
		noResults: '找不到特效',
		noResultsAnimated: '找不到动态特效',
		navLabel: '主导航',
		navExplore: '探索',
		navEditor: '编辑器',
		openEditor: '打开编辑器',
	...
	effectsPanel: {
		tabs: { effects: '效果', animated: '动态', favorites: '收藏', presets: '预设' },
		animatedSection: '动态效果',
		animBadge: '动态',
		expandPanel: '展开效果面板',
		collapsePanel: '折叠效果面板',
		search: '搜索…',
		searchAnimated: '搜索动态效果…',
		searchPresets: '搜索预设…',
		popular: '★ 热门',
		noEffects: '找不到效果',
		noAnimated: '找不到动态效果',
